namespace KT.API.Filters
{
    public class ExceptionHandler : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            if (context.Exception is KTException exception)
            {
                _logger.LogError(KTEventId.BadRequest, exception, exception.Message);
            ...
            {
                _logger.LogError(KTEventId.InternalServerError, context.Exception, context.Exception.Message);
